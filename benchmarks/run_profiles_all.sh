...
profile_case "simulation.guardrails" "compile_scenario"
profile_case "simulation.guardrails" "single_run"
profile_case "simulation.guardrails" "single_run_expanded_semantics"
profile_case "simulation.guardrails" "batch_run_sequential"
profile_case "simulation.guardrails" "batch_run_expanded_semantics"
profile_case "simulation.guardrails" "artifact_write_path"

# simulation.hotspots
profile_case "simulation.hotspots" "compile_large_topology"
profile_case "simulation.hotspots" "single_run_expression_fanout"
profile_case "simulation.hotspots" "single_run_expression_fanout_with_events"
