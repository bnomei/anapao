...
DEVANA-SUMMARY: Status=open | P3 medium src/assertions/mod.rs:415 - MonotonicNonDecreasing detects decreases only via `>`, so a NaN between two decreasing points yields a false pass.
